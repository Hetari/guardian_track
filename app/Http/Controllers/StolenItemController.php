...
class StolenItemController extends Controller
{
    public function store(Request $request)
    {
        $validated = $request->validate([
            ...
            'stolen_date_time' => 'required|date|before:now',
            'stolen_item_type' => 'required|in:Bag,Shoe,Watch,Other',
        ...
        StolenItem::create($validated);

        return redirect()->back()->with('success', 'Stolen item reported successfully.');
    }
